...
func ParseCmap(src []byte) (Cmap, int, error) {
	...
	{
		if L := len(src); L < 4 {
			return Cmap{}, 0, fmt.Errorf("EOF: expected length: 4, got %d", L)
		}
	...
	}
	{
		...
		if L := len(src); L < 4+arrayLength*8 {
			return Cmap{}, 0, fmt.Errorf("EOF: expected length: %d, got %d", 4+arrayLength*8, L)
		}
...
func ParseCmapSubtable0(src []byte) (CmapSubtable0, int, error) {
	...
	n := 0
	if L := len(src); L < 262 {
		return CmapSubtable0{}, 0, fmt.Errorf("EOF: expected length: 262, got %d", L)
	}
	item.mustParse(src)
	n += 262
	return item, n, nil
...
func ParseCmapSubtable10(src []byte) (CmapSubtable10, int, error) {
	...
	{
		if L := len(src); L < 20 {
			return CmapSubtable10{}, 0, fmt.Errorf("EOF: expected length: 20, got %d", L)
		}
	...
	}
	{
		...
		if L := len(src); L < 20+arrayLength*2 {
			return CmapSubtable10{}, 0, fmt.Errorf("EOF: expected length: %d, got %d", 20+arrayLength*2, L)
		}
...
func ParseCmapSubtable12(src []byte) (CmapSubtable12, int, error) {
	...
	{
		if L := len(src); L < 16 {
			return CmapSubtable12{}, 0, fmt.Errorf("EOF: expected length: 16, got %d", L)
		}
	...
	}
	{
		...
		if L := len(src); L < 16+arrayLength*12 {
			return CmapSubtable12{}, 0, fmt.Errorf("EOF: expected length: %d, got %d", 16+arrayLength*12, L)
		}
...
func ParseCmapSubtable13(src []byte) (CmapSubtable13, int, error) {
	...
	{
		if L := len(src); L < 16 {
			return CmapSubtable13{}, 0, fmt.Errorf("EOF: expected length: 16, got %d", L)
		}
		_ = src[15] // early bound checking
		item.format = binary.BigEndian.Uint16(src[0:])
		item.reserved = binary.BigEndian.Uint16(src[2:])
	...
	}
	{
		...
		if L := len(src); L < 16+arrayLength*12 {
			return CmapSubtable13{}, 0, fmt.Errorf("EOF: expected length: %d, got %d", 16+arrayLength*12, L)
		}
...
func ParseCmapSubtable14(src []byte) (CmapSubtable14, int, error) {
	...
	{
		if L := len(src); L < 10 {
			return CmapSubtable14{}, 0, fmt.Errorf("EOF: expected length: 10, got %d", L)
		}
	...
	}
	{
		...
		if L := len(src); L < 10+arrayLength*11 {
			return CmapSubtable14{}, 0, fmt.Errorf("EOF: expected length: %d, got %d", 10+arrayLength*11, L)
		}
...
func ParseCmapSubtable2(src []byte) (CmapSubtable2, int, error) {
	...
	{
		if L := len(src); L < 2 {
			return CmapSubtable2{}, 0, fmt.Errorf("EOF: expected length: 2, got %d", L)
		}
		item.format = binary.BigEndian.Uint16(src[0:])
		n += 2
	}
...
func ParseCmapSubtable4(src []byte) (CmapSubtable4, int, error) {
	...
	{
		if L := len(src); L < 14 {
			return CmapSubtable4{}, 0, fmt.Errorf("EOF: expected length: 14, got %d", L)
		}
	...
	}
	{
		...
		if L := len(src); L < 14+arrayLength*2 {
			return CmapSubtable4{}, 0, fmt.Errorf("EOF: expected length: %d, got %d", 14+arrayLength*2, L)
		}
	...
	{
		if L := len(src); L < n+2 {
			return CmapSubtable4{}, 0, fmt.Errorf("EOF: expected length: 2, got %d", L)
		}
	...
	}
	{
		...
		if L := len(src); L < n+arrayLength*2 {
			return CmapSubtable4{}, 0, fmt.Errorf("EOF: expected length: %d, got %d", n+arrayLength*2, L)
		}
...
func ParseCmapSubtable6(src []byte) (CmapSubtable6, int, error) {
	...
	{
		if L := len(src); L < 10 {
			return CmapSubtable6{}, 0, fmt.Errorf("EOF: expected length: 10, got %d", L)
		}
		_ = src[9] // early bound checking
		item.format = binary.BigEndian.Uint16(src[0:])
		item.length = binary.BigEndian.Uint16(src[2:])
	...
	}
	{
		...
		if L := len(src); L < 10+arrayLength*2 {
			return CmapSubtable6{}, 0, fmt.Errorf("EOF: expected length: %d, got %d", 10+arrayLength*2, L)
		}
...
func ParseDefaultUVSTable(src []byte) (DefaultUVSTable, int, error) {
	...
	{
		if L := len(src); L < 4 {
			return DefaultUVSTable{}, 0, fmt.Errorf("EOF: expected length: 4, got %d", L)
		}
		arrayLength := int(binary.BigEndian.Uint32(src[0:]))
		n += 4

		if L := len(src); L < 4+arrayLength*4 {
			return DefaultUVSTable{}, 0, fmt.Errorf("EOF: expected length: %d, got %d", 4+arrayLength*4, L)
		}
...
func ParseUVSMappingTable(src []byte) (UVSMappingTable, int, error) {
	...
	{
		if L := len(src); L < 4 {
			return UVSMappingTable{}, 0, fmt.Errorf("EOF: expected length: 4, got %d", L)
		}
		arrayLength := int(binary.BigEndian.Uint32(src[0:]))
		n += 4

		if L := len(src); L < 4+arrayLength*5 {
			return UVSMappingTable{}, 0, fmt.Errorf("EOF: expected length: %d, got %d", 4+arrayLength*5, L)
		}
