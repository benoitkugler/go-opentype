...
// Code generated by binarygen from hhea_vhea.go. DO NOT EDIT
...
func (item *Hhea) mustParse(src []byte) {
	...
	for i := range item.reserved {
		item.reserved[i] = binary.BigEndian.Uint16(src[24+i*2:])
	}
...
func ParseHhea(src []byte) (Hhea, int, error) {
	...
	n := 0
	if L := len(src); L < 36 {
		return Hhea{}, 0, fmt.Errorf("EOF: expected length: 36, got %d", L)
	}
